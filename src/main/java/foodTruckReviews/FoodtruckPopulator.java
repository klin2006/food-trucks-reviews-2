...
public class FoodtruckPopulator implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		reviewRepo.save(new Review("Ray Ray's BBQ has great quality meat that have great smoke rings as well as tasty sides it's a great choice for those who love great BBQ. They also have by the pound and catering options to fill out almost any need.", rays));
